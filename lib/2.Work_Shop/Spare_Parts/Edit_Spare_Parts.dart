...
class Edit_Spare_Parts extends StatefulWidget {
  ...
  Edit_Spare_Parts({required this.list, required this.index});

  @override
  _Edit_Spare_PartsState createState() => new _Edit_Spare_PartsState();
}

class _Edit_Spare_PartsState extends State<Edit_Spare_Parts> {
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: new TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return "Please enter  Spare parts details";
                      }
                      return null;
                    },
                    onSaved: (place) {},
                    decoration: InputDecoration(
                        ...
                        hintText: "Enter Spare parts details",
                        label: Text('Spare parts details'),
                        hintStyle: TextStyle(color: Colors.grey),
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10),
                        )),
