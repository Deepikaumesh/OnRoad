...
class View_Spare_Parts extends StatefulWidget {
  @override
  _View_Spare_PartsState createState() => _View_Spare_PartsState();
}

class _View_Spare_PartsState extends State<View_Spare_Parts> {
  Future<List> getData() async {
    final response = await http.get(Uri.parse(
        "http://$ip/MySampleApp/ORBVA/Work_shop/spare_Parts_display.php"));
        ...
        return Container(
          ...
          child: GestureDetector(
            onTap: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => Spare_Parts_detail(
                      list: list,
                      index: i,
                    ))),
            child: Card(
