...
class Crain_detail extends StatefulWidget {
  ...
  Crain_detail({required this.index, required this.list});

  @override
  _Crain_detailState createState() =>  _Crain_detailState();
}

class _Crain_detailState extends State<Crain_detail> {
  void deleteData() {
    //var url="http://10.0.2.2/my_store/deleteData.php";
    var url = "http://$ip/MySampleApp/ORBVA/Work_shop/delete_crain.php";
  ...
  void confirm() {
    AlertDialog alertDialog =  AlertDialog(
      content:  Text(
          "Are You sure want to delete '${widget.list[widget.index]['Owner_name']}'"),
      actions: <Widget>[
         ElevatedButton(
          style: ButtonStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              Text(widget.list[widget.index]['Owner_name'],style: GoogleFonts.prompt(fontSize: 17),),
              SizedBox(
                height: 40,
              ),
            ]),
            SizedBox(
              ...
              Text("Crain Details",style: GoogleFonts.prompt(fontSize: 20)),
              Padding(
                ...
                child: Container(
                  ...
                  child:  Padding(
                      ...
                      child: Text(widget.list[widget.index]['Crain_details'],style: GoogleFonts.prompt(fontSize: 17),textAlign: TextAlign.justify,)),
              ...
              children: [
                ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        new MaterialPageRoute(
                          builder: (BuildContext context) => new Edit_Crain(
                            list: widget.list,
                            index: widget.index,
                          ),
                        ),
