...
class Display_Request_Page_Service extends StatefulWidget {
  const Display_Request_Page_Service({Key? key}) : super(key: key);

  @override
  _Display_Request_Page_ServiceState createState() =>
      _Display_Request_Page_ServiceState();
}

class _Display_Request_Page_ServiceState
    extends State<Display_Request_Page_Service> {
  ...
  Future<List> getData() async {
    final response = await http.get(Uri.parse(
        "http://$ip/MySampleApp/ORBVA/Customer/Display_Service_Center.php"));
